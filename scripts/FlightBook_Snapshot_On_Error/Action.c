Action()
{
	...
	web_image("Search Flights Button Error", 
		"Alt=Search Flights Button Error", 
		"Snapshot=t15.inf", 
		EXTRARES, 
		"Url=FormDateUpdate.class", "Referer=", ENDITEM, 
		"Url=CalSelect.class", "Referer=", ENDITEM, 
	...
	web_image("Itinerary Button Error", 
		"Alt=Itinerary Button Error", 
		"Snapshot=t19.inf", 
		LAST);
	...
	web_image("SignOff Button Error", 
		"Alt=SignOff Button Error", 
		"Snapshot=t20.inf", 
		LAST);
