getmessagesashx()
{
	lr_start_transaction("/handlers/getmessages.ashx");
		...
		web_url("/handlers/getmessages.ashx", 
			"URL=http://www.mydomain.com/postaround/handlers/getmessages.ashx?currlat=&currlon=&uptometers=-1&timezone=2&fromnumber=0&categoryid=*&sortby=0&ismine=0&takenum=20", 
			"Resource=0", 
